        ...
        {segments
          ...
          .map((segment) => (
            <motion.span
              ...
              className="min-w-1 basis-0 outline-none transition-[filter] hover:brightness-115 focus-visible:brightness-115 focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:ring-inset"
