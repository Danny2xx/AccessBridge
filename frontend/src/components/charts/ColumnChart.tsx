        ...
        {ticks.map((tick) => (
          <g key={tick} aria-hidden="true">
            ...
            <text
              ...
              dy="0.32em"
              textAnchor="end"
              className="tabular fill-dim text-xs"
            >
              {tickLabel(tick)}
            </text>
          </g>
          ...
          return (
            <g key={point.key} className="group">
              <motion.path
                ...
                className="group-hover:fill-proposal-ui group-focus-within:fill-proposal-ui fill-proposal transition-[fill]"
              ...
              {point.labelled ? (
                <text
                  ...
                  y={top - 8}
                  textAnchor="middle"
                  className="tabular fill-foreground text-xs font-bold"
                >
